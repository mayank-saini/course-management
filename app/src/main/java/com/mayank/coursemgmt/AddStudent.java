...
import static com.mayank.coursemgmt.EncryptionDecryptionUtility.encrypt;
...
public class AddStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sbranch.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                String shortBranch = returnShortBranch(sbranch.getSelectedItem().toString());
                studentidbranch = shortBranch;
                tvstudentidprebranch.setText(shortBranch);
            }
